module github.com/Schaudge/doppelmark
...
require (
	...
	github.com/yasushi-saito/zlibng v0.0.0-20190922135643-2a860060b80c // indirect
...
replace github.com/tildeleb/hashland v0.1.5 => leb.io/hashland v0.1.5
